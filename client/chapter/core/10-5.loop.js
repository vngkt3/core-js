...
// 객체 => 배열로 만들고 for .. of 를 돌림  그러면 항상 prototype에서 바꿔줘야 하느냐 그건아님

// Objcet.keys() => 객체들의 키를 모아 하나의 ★ '배열로 반환' ★
// Objcet.values() => 객체들의 값을 모아 하나의 ★ '배열로 반환' ★
// Objcet.entries() => 객체의 키와 값을 하나의 쌍으로 만들고 이를 ★ '배열로 반환' ★
